...
class ChangeOption {
    ...
    var name: String
    var currrency: String
    var BgC: UIColor
    var BgI: UIImage
    var course: String
    
    init(name: String, currrency: String, BgC: UIColor, BgI: UIImage, course: String) {
        self.name = name
...
class Change: UIViewController {
    ...
    func configure(){
        models.append(contentsOf: [
            ChangeOption(name: "AMD", currrency: "ARMENIA", BgC: .cyan, BgI: UIImage(named: "arm")!, course: "1"),
            ChangeOption(name: "RUB", currrency: "RUSSIA", BgC: .cyan, BgI: UIImage(named: "rus")!, course: "1"),
            ChangeOption(name: "USD", currrency: "USA", BgC: .cyan, BgI: UIImage(named: "usa")!, course: "1"),
            ChangeOption(name: "EUR", currrency: "EURO", BgC: .cyan, BgI: UIImage(named: "euro")!, course: "1"),
            ChangeOption(name: "KZT", currrency: "KAZAKSTAN", BgC: .cyan, BgI: UIImage(named: "kzt")!, course: "1"),
            ChangeOption(name: "EUR", currrency: "FRANCE", BgC: .cyan, BgI: UIImage(named: "france")!, course: "1"),
            ChangeOption(name: "JPY", currrency: "JAPAN", BgC: .cyan, BgI: UIImage(named: "japan")!, course: "1"),
            ChangeOption(name: "EUR", currrency: "GERMANIA", BgC: .cyan, BgI: UIImage(named: "germany")!, course: "1"),
            ChangeOption(name: "GBP", currrency: "ENGLAND", BgC: .cyan, BgI: UIImage(named: "england")!, course: "1"),
            ChangeOption(name: "UAR", currrency: "UKRANYA", BgC: .cyan, BgI: UIImage(named: "ukrain")!, course: "1"),
        ])
    }
        func fetchJson(){
