...
class ChangeViewController: UIViewController {
    ...
    @IBOutlet weak var pikerV: UIPickerView!
    ...
    override func viewDidLoad() {
        ...
        pikerV.setValue(UIColor.white, forKey: "textColor")
        pikerV.tintColor = .white
    ...
    @IBAction func deletNum(_ sender: Any){
    ...
    @IBAction func enter(_ sender: Any){
        ...
        if currencyText.text   != ""{
            let tobal = theAmountText * activeCurrency
            firstCount.text = String(format: "% 2f",tobal)
        }
    }
            ...
            URLSession.shared.dataTask(with: url) { (data, response, error) in
                ...
                do {
                    ...
                    DispatchQueue.main.async {
                        self.pikerV.reloadAllComponents()
